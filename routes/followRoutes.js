...
import { followUser, unfollowUser, followStatus, getFollowers,getFollowing } from '../controllers/followControllers.js'
...
router.get("/following/:userId", auth, blockGuest, getFollowing);
